...
pub fn card_container(theme: &Theme) -> container::Style {
    container::Style {
        ...
        border: Border {
            color: theme.palette().secondary.weak.text.scale_alpha(0.1),
            width: 1.0,
...
pub fn label_text(theme: &Theme) -> text::Style {
    text::Style {
        color: Some(theme.palette().secondary.weak.text.scale_alpha(0.8)),
    }
}
...
pub fn muted_text(theme: &Theme) -> text::Style {
    text::Style {
        color: Some(theme.palette().secondary.weak.text.scale_alpha(0.6)),
    }
}
...
pub fn subtitle_text(theme: &Theme) -> text::Style {
    text::Style {
        color: Some(theme.palette().secondary.weak.text.scale_alpha(0.7)),
    }
}
